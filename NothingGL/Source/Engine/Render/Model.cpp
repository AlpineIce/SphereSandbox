...
namespace Renderer
{
	...
	void Mesh::draw(Camera& camera, glm::mat4& instMatrix)
	{
	...
	void Model::processNode(aiNode* node, const aiScene* scene)
	{
		...
		for (unsigned int i = 0; i < node->mNumMeshes; i++)
		{
			...
			meshes.push_back(std::make_shared<Mesh>(meshData.vertices, meshData.indices, nullptr)); //TODO ASSIGN MATERIAL
		}
